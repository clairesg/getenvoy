...
var (
	// SupportedCategories are extension categories supported by the `init` command for each language.
	...
	// SupportedLanguages are programming languages supported by the `init` command.
